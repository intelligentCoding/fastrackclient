    ...
    <div className="min-w-[1000px] bg-[#e5e7eb] p-10">
      <Card className="mb-8 flex flex-col items-center justify-between md:flex-row">
        <div className="mb-4 md:mb-0 md:w-1/4">
          <h1 className="text-lg font-semibold text-heading">CheckbookUld</h1>
        </div>
      ...
      {editMode ? (
        <CreateOrUpdateUld initialValues={currentUld} setEditMode={setEditMode} checkbookId={data.id} />
        ) : (  
         <CheckbookUldList  setEditMode={setTheEditMode} setCurrentUld={setCurrentUld} refetch={refetch} uld={ulds || []} /> 
        )}  
    </div>
    </LoadingContainer>
    </>
